...
def load_custom_css():
    ...
    <style>
        ...
        .eval-container {
            ...
            padding: 15px;
            margin-top: 20px;
            height: 100%; /* Agar tinggi container sama di satu baris */
        }
...
if data_bulanan is not None:
    ...
    if predict_button:
        ...
        # [PERBAIKAN UTAMA] Mengembalikan layout 2 kolom untuk tabel dan evaluasi
        st.markdown("---")
        ...
        with col1:
            ...
            st.dataframe(display_df, use_container_width=True, height=400) # Sesuaikan tinggi jika perlu
