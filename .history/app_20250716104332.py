...
def load_custom_css():
    ...
    <style>
        ...
        /* [PERUBAHAN UTAMA] Desain Kartu (Container) yang konsisten */
        .card {
...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader("Upload file Excel Anda di sini:", type=['xlsx', 'xls'])
...
if data_bulanan is not None:
    ...
    # [PERUBAHAN UTAMA] Halaman Selamat Datang yang Baru
