...
if data_bulanan is not None:
    ...
    if predict_button:
        ...
        # --- [PERUBAHAN UTAMA] ---
        # 1. Tampilkan Tabel Prediksi terlebih dahulu (full-width)
